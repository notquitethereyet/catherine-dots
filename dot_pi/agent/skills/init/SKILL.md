---
name: init
description: Creates or updates an AGENTS.md file with project-specific development rules, coding standards, and workflow instructions. Use when starting a new project, when a project lacks AGENTS.md, or when the user asks to initialize or bootstrap project conventions.
---
